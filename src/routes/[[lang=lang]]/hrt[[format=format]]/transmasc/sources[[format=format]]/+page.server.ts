...
export async function load({ parent }) {
	...
	return {
		lite: false,
		title: await fetchLocaleString('ui.hrt.pages.transmasc-sources', lang),
		nav: hrtNav(lang),
		sections: await Promise.all([
		fetchLocaleFragment('ui/hrt/transmasc/sources/diy-sources', lang).then(renderFragmentToHtml)
		])
	};
}
