...
export async function load({ parent }) {
	...
	return {
		lite: false,
		title: await fetchLocaleString('ui.guides.pages.intramuscular-injection', lang),
		nav: guidesNav(lang),
		sections: await Promise.all([
			fetchLocaleFragment('ui/guides/intramuscular-injection', lang).then(renderFragmentToHtml),
		])
	};
}
