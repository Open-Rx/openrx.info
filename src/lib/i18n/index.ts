...
// refactor: preload locale files in order to include them in svelte builds. 
// we can fix i18n needing a rebuild later, maybe an api of sorts?
export { fetchLocaleFragment, fetchLocaleString } from './preload'; 